/**
 * Pinned migration checksums for databases migrated before the current checksum scheme.
 *
 * GENERATED — do not edit by hand. `full` lists full-text checksums (the scheme that hashed
 * the whole file) of known earlier revisions. `earlier` lists comment-insensitive checksums of
 * reviewed earlier revisions. `normalized` is the checksum of the revision on disk.
 * `runMigrations` accepts a recorded `full` or `earlier` value only when the file on disk
 * still has checksum `normalized`, then rewrites the record.
 */
...
export const LEGACY_CHECKSUMS: Readonly<Record<string, LegacyChecksum>> = {
  ...
  "0003_guards.sql": {
    ...
    earlier: ["d9337958a20351fc10cc3ba6c4d5bbcb6a0917efede11d19815be204ae9d8e06"],
    normalized: "136032b4b5950cd58bf054f47ddae5b43bbc3541ba3496644e2f3e8f13b4f4e7",
  },
  "0004_siwe_nonce.sql": {
  ...
  "0007_object_uploads.sql": {
    ...
    earlier: ["2ec46e0f6db569e1049b631486cc9bce9d65f6dbd296b1aa0b621eed1fc9e403"],
    normalized: "1c90c96a7603fb872fab958278a763c86b117fe3020414ff7905c80a7e2f92a2",
  },
  ...
  "0017_governance.sql": {
    ...
    earlier: ["441028680aa9d360a577b6c8dc9e294f2e82a04dd4433cf5fad8c40761acd1c4"],
    normalized: "b15038b5c3a659ffd2a96b20abd4fade35429c0509afaae2053abef47fa728bf",
  },
  "0018_vote_snapshot.sql": {
    ...
    earlier: ["59d40982ce0b704d720fb861ef501dac40dc2ca72192d7ed71d8fe5db4f2d39c"],
    normalized: "857be7092851eb8615358c93e42df736d9dba18d6a6be0415b0b4ebdeb65cf61",
  },
  ...
  "0020_authority_registry.sql": {
    ...
    earlier: ["3f41cbcc39f7d55ff6b5458ab567995032d187d33aafebd1396a857b3be037ac"],
    normalized: "a7c4ba86e855b81efa252734ac9cf866b89557f5369cbc37c4e85fff98689a49",
  },
  ...
  "0022_storage_tier.sql": {
    ...
    earlier: ["7d69798fa6a1aad866185addd6dac647ce8fb1e46b9cf0823ec95317e094736b"],
    normalized: "4c25fed129c2cb02cce4b4fe8dae7b689419510b2808073efc4b3adf87915883",
  },
  "0023_stale_propagation.sql": {
    ...
    earlier: ["4abdfab9140feab933e7c7cf465ec69870b443ce58970a3d5ea87356ae345ea4"],
    normalized: "84b537f06546e30d22b800f3d912455d5b583a98025f02fe563103b0ac0f6f14",
  },
  "0024_stale_signals.sql": {
    ...
    earlier: ["618e41e8a221f38dd92038be0824460aeb349ecaf5521e77da4c74283ea164e4"],
    normalized: "c1104ebad5a8ac610186b06ad71d3a9b12dca179b32f34835311b05499351332",
  },
  "0025_eligible_weight.sql": {
    ...
    earlier: ["23036c97f06a410b8c84f9f6c50ea38341c54fcb3616591aaa85b9270c6289f7"],
    normalized: "bb0ce54435697e45c52cd92dc641b08b8d821ed6c1e36df8201db1927d0cbfb3",
  },
  ...
  "0030_notifications.sql": {
    ...
    earlier: ["eb8b6ad1179fffe7dce4c4e8991c3757f0988c61aa0621cc5cef1c3b39c3d848"],
    normalized: "30578ac4a9c9a1a94bc6083ae5d15eae2ca6dad254a47fe89c7c6c628f5658b5",
  },
