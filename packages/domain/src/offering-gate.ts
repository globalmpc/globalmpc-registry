...
export const OFFERING_ABSENCE_COPY =
  "This project has no asset or offering functionality. It is not built and not hidden behind a flag.";

export const OFFERING_NOT_MEANING =
  "Data readiness, governance approval, and verification signatures are not issuance approval.";
