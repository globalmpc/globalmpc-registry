...
const NEGATIONS: readonly { readonly text: string; readonly why: string }[] = [
  {
    text: "Government approval or an MPC guarantee",
    why: "An entry of the inclusion proof's `doesNotProve` list — it states the proof does not establish government approval.",
  },
];
