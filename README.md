...
| `packages/db` | Schema, RLS, append-only guards, composite FKs, migration checksums | 60 |
...
Total: vitest 1302 + Playwright 88 + Foundry 29 + route 81. (measured 2026-09-14)
...
- **Warnings cannot be removed by switching language** → boundary wording originates in `@mpc/ui`;
  only translations differ
